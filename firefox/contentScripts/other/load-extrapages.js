...
(function() {
    ...
    document.dispatchEvent(new CustomEvent("injectedScript", { detail: { name: "other/load-extrapages.js" } }));
    ...
    async function main(pagesToFetch) {
        ...
        try {
            ...
            document.dispatchEvent(new CustomEvent("parseTooltips", { detail: true }));
    ...
    (async () => {
        try {
            const response = await callRequestFromLocal('getLocalStorageValue', 'pagesToSearch');
